...
$patient_aadhaar_l=$_POST['patient_aadhaar'];
...
$sql = "SELECT * FROM patient1 WHERE aadhaar = '$patient_aadhaar_l'";
		...
		$count1=mysqli_num_rows($result1); 
				if (($count1==0)) {
					...
					curl_close($ch);
					*/
					echo '1';//'THE OTP is sent to equivalent mobile number for'." ".$patient_aadhaar_l.' aadhaar number';
